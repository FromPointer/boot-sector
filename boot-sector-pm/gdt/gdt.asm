...
; A segment register becomes an index to a particular segment descriptor (SD) in the GDT
; A segment descriptor format(8bytes):
; 		Base address(32bit)
; 		segment limit(20bit)
; 		variable flags
...
; which are what segment registers must contain when in protected mode. For example,
